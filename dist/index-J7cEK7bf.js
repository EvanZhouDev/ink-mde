...
import { SelectionRange as xn, EditorSelection as vn, Compartment as we, RangeSetBuilder as qe, EditorState as yn, StateField as wn, RangeSet as te } from "@codemirror/state";
import { defaultKeymap as $n, historyKeymap as _n, history as Mn } from "@codemirror/commands";
import { EditorView as V, Decoration as j, ViewPlugin as Ie, keymap as Sn } from "@codemirror/view";
import { markdown as Ne, markdownLanguage as Re } from "@codemirror/lang-markdown";
import { languages as Ve } from "@codemirror/language-data";
import { tags as u, Tag as Cn } from "@lezer/highlight";
import { createSignal as R, Show as x, onMount as We, onCleanup as Ln, For as En, createEffect as jn, createContext as Bn, useContext as An } from "solid-js";
...
const Be = {
  ...
  const r = t || Ue(e.state.selection).pop() || { start: 0, end: 0 };
...
}, Qe = (e) => e.editor.state.sliceDoc(e.selection.start, e.selection.end), In = (e, n, t) => Nn(e, t).find(({ type: o }) => n.nodes.includes(o.name)), Nn = (e, n) => {
  const t = [];
  ...
  const n = Qe(e), t = e.formatDefinition.prefix.length, r = e.formatDefinition.suffix.length * -1 || n.length, o = n.slice(t, r);
  return [{ from: e.selection.start, to: e.selection.end, insert: o }];
}, Rn = (e) => {
  if (e.node) {
    const n = e.node.from, t = e.node.to;
    return $e({ ...e, selection: { start: n, end: t } });
  } else {
  ...
  const n = e.formatDefinition.prefixStates.length > 0, t = Qe(e);
  if (e.node && n) {
...
}, Fn = (e) => e.formatDefinition.block ? Rn(e) : e.formatDefinition.multiline ? Vn(e) : e.formatDefinition.line ? Ke(e) : Wn(e), Xe = ([e], n, { selection: t } = {}) => {
  ...
  const t = /* @__PURE__ */ new WeakMap(), r = (o, i) => t.get(o) || (U(o, N.object) && t.set(o, !0), U(i, N.undefined)) ? o : U(o, N.array) && U(i, N.array) ? [...i] : U(o, N.object) && U(i, N.object) ? Object.keys(o).reduce((s, a) => (Object.hasOwnProperty.call(i, a) ? s[a] = r(o[a], i[a]) : s[a] = o[a], s), {}) : i;
  return r(e, n);
}, ee = (e, n) => Kn(e, n), Xn = {
  array: "[object Array]",
  ...
  undefined: "[object Undefined]",
  window: "[object Window]"
}, Yn = (e, n) => Object.prototype.toString.call(n) === e, Ye = (e) => Yn(Xn.promise, e), ue = (e) => Gn(e, Ye), Zn = (e, n) => n.type === e, Jn = (e, n) => !!e && e in n, Q = (e, n) => Ze(n.plugins).reduce((t, r) => (Zn(e, r) && (!r.key || Jn(r.key, n) && n[r.key]) && t.push(r.value), t), []), Ze = (e) => e.reduce((n, t) => Array.isArray(t) ? n.concat(Ze(t)) : n.concat(t), []), Gn = (e, n) => e.reduce((t, r) => (n(r) ? t[0].push(r) : t[1].push(r), t), [[], []]), et = ([e, n]) => {
...
}, nt = (e) => ue(Q(W.grammar, e)), tt = (e) => ue(Q(W.language, e)), rt = async ([e]) => {
  const n = [], t = await Promise.all(Q(W.grammar, e().options)), r = await Promise.all(Q(W.language, e().options));
  return Ne({
    base: Re,
    codeLanguages: [...Ve, ...r],
    extensions: [...n, ...t]
...
}, Ae = () => document.createElement("div"), Je = () => window.matchMedia("(prefers-color-scheme: dark)").matches, it = (e) => e === ae.Dark ? !0 : e === ae.Light ? !1 : Je(), me = (e) => {
  const n = [
    // --ink-*
  ...
  const t = e().extensions.map(
    (r) => r.initialValue([e, n])
  );
  ...
  async ([e], n) => {
    if (e().options.interface.autocomplete) {
      const { autocomplete: t } = await import("./autocomplete-A3VXerIf.js");
  ...
  async ([e], n) => {
    if (e().options.interface.lists) {
      const { lists: t } = await import("./lists-FpgtHIL1.js");
      return n.reconfigure(t());
    }
    return n.reconfigure([]);
  },
  ...
  async (e, n) => {
    const { markdownKeymap: t } = await import("./markdownKeymap-DSSOXZJ2.js"), r = t(e);
    return n.reconfigure(r());
  }
], mt = [
  "Blockquote"
  ...
  spellcheck: "false"
}, yt = j.line({ attributes: { ...K, class: "cm-codeblock" } }), wt = j.line({ attributes: { ...K, class: "cm-codeblock-open" } }), $t = j.line({ attributes: { ...K, class: "cm-codeblock-close" } }), _t = j.mark({ attributes: { ...K, class: "cm-code" } }), Mt = j.mark({ attributes: { ...K, class: "cm-code cm-code-open" } }), St = j.mark({ attributes: { ...K, class: "cm-code cm-code-close" } }), Ct = Ie.define((e) => ({
  update: () => Lt(e)
        ...
        enter({ type: a, from: l, to: c }) {
          if (a.name !== "Document")
            if (vt.includes(a.name)) {
              ...
              return f.number === i.number && n.add(i.from, i.from, wt), _.number === i.number && n.add(i.from, i.from, $t), !1;
            } else
...
}, It = ([e, n], { after: t, before: r, selection: o }) => {
  ...
  const n = {
    ...
    load: Tt.bind(void 0, e),
    options: Dt.bind(void 0, e),
    reconfigure: Pt.bind(void 0, e),
    select: en.bind(void 0, e),
    selections: _e.bind(void 0, e),
    update: qt.bind(void 0, e),
    wrap: It.bind(void 0, e)
  };
  return Nt(n, (t, r) => {
    try {
      const [o] = e;
    ...
    enter: (r) => {
      if (n.nodes.includes(r.type.name)) {
        ...
        Array().concat(o).forEach((s) => {
          ...
          if (s.spec.type === "mark") {
            const a = Vt({ ...s.spec, node: { ...r } }).range(r.from, r.to);
            t.push(a);
          }
  ...
  n.changes.iterChangedRanges((c, f, _, y) => {
    i.forEach((w) => {
      if (w.value) {
        const q = w.value.spec.node.to - w.value.spec.node.from, I = w.from, T = w.from + q;
        Ft(I, T, _, y) && s.push(w);
      }
    });
    const S = { from: _, to: y };
...
}, Ft = (e, n, t, r) => Math.max(e, t) <= Math.min(n, r), ze = (e) => wn.define({
  create(n) {
    return te.of(ie(n, e));
  },
  update(n, t) {
    ...
    return t.docChanged ? e.optimize ? te.of(Wt(r, t, e)) : te.of(ie(t.state, e)) : r;
  },
  provide(n) {
    return V.decorations.from(n);
  }
}), Ut = (e) => Cn.define(e), Qt = (e) => e.charCodeAt(0), X = (e) => Me(e, [u.processingInstruction]), Me = (e, n = []) => {
  const t = Ut();
  return {
    node: Zt({
      name: e,
...
}, Kt = (e) => e, Xt = (e) => e, Yt = (e) => e, Zt = (e) => e, Jt = (e, n) => {
  const t = e[n];
  ...
  get: (e, n, t) => e[n] ? e[n] : e[n] = (async () => {
    const { importer: r } = await Jt(/* @__PURE__ */ Object.assign({ "./importers/katex.ts": () => import("./katex-deDlmqXG.js") }), `./importers/${n}.ts`), o = await r();
    return e[n] = o, o;
  })()
}), Gt = (e, n) => {
  if (!re[e])
  ...
  dollarSign: Qt("$")
}, er = /\$.*?\$/, nr = /\$(?<math>.*?)\$/, se = Me("MathInline"), le = X("MathInlineMark"), Se = X("MathInlineMarkOpen"), Ce = X("MathInlineMarkClose"), tr = Xt({
  name: se.node.name,
  parse: (e, n, t) => {
    if (n !== G.dollarSign)
      return -1;
...
}), sn = Me("MathBlock"), be = X("MathBlockMark"), ln = X("MathBlockMarkOpen"), cn = X("MathBlockMarkClose"), rr = Kt({
  name: "MathBlock",
  parse: (e, n) => {
...
`);
  ...
  const [t, r] = R(sr({ ...n, doc: e.doc || "", options: e }));
  return [t, r];
}, Ee = 225, lr = (e, n = Ee) => {
  const t = ur(e, n), r = fr(e), o = dr(e), i = cr(e);
  return [t, r, o, i].join(" | ");
}, cr = (e) => `${mr(e)} chars`, dr = (e) => `${gr(e)} lines`, ur = (e, n = Ee) => {
  const t = pr(e, n), r = Math.floor(t), o = Math.floor(t % 1 * 60);
  return r === 0 ? `${o}s read` : `${r}m ${o}s to read`;
}, fr = (e) => `${dn(e)} words`, mr = (e) => e.length, gr = (e) => e.split(/\n/).length, pr = (e, n = Ee) => dn(e) / n, dn = (e) => {
  const n = e.replace(/[']/g, "").replace(/[^\w\d]+/g, " ").trim();
  return n ? n.split(/\s+/).length : 0;
}, kr = /* @__PURE__ */ p("<div class=ink-mde-readability><span>"), hr = /* @__PURE__ */ p("<span>&nbsp;|"), br = /* @__PURE__ */ p('<div class=ink-mde-attribution><span>&nbsp;powered by <a class=ink-mde-attribution-link href=https://github.com/davidmyersdev/ink-mde rel="noopener noreferrer"target=_blank>ink-mde'), xr = /* @__PURE__ */ p("<div class=ink-mde-details><div class=ink-mde-container><div class=ink-mde-details-content><!$><!/><!$><!/><!$><!/>"), vr = () => {
  const [e] = Y();
  return (() => {
    const n = m(xr), t = n.firstChild, r = t.firstChild, o = r.firstChild, [i, s] = h(o.nextSibling), a = i.nextSibling, [l, c] = h(a.nextSibling), f = l.nextSibling, [_, y] = h(f.nextSibling);
    return g(r, d(x, {
      get when() {
        return e().options.readability;
      },
      get children() {
        const S = m(kr), w = S.firstChild;
        return g(w, () => lr(e().doc)), S;
      }
    }), i, s), g(r, d(x, {
      get when() {
...
}, yr = ".ink-drop-zone{align-items:center;background-color:#00000080;color:var(--ink-internal-color);display:flex;inset:0;justify-content:center;position:var(--ink-internal-modal-position);z-index:100}.ink-drop-zone:not(.visible){display:none}.ink-drop-zone-modal{background-color:var(--ink-internal-block-background-color);border-radius:var(--ink-internal-border-radius);box-sizing:border-box;height:100%;max-height:20rem;max-width:40rem;padding:1rem;position:relative;width:100%}.ink-drop-zone-hide{cursor:pointer;height:1.75rem;position:absolute;right:.25rem;top:.25rem;width:1.75rem}.ink-drop-zone-hide svg{background-color:var(--ink-internal-block-background-color)}.ink-drop-zone-droppable-area{align-items:center;border:.2rem dashed var(--ink-internal-color);border-radius:.125rem;box-sizing:border-box;display:flex;flex-direction:column;font-size:1.25em;gap:1rem;height:100%;justify-content:center;padding:1rem;text-align:center}.ink-drop-zone-file-preview{align-items:center;display:flex;flex-wrap:wrap;gap:.5rem;max-width:25.5rem}.ink-drop-zone-file-preview-image{border:.125rem solid #222;border-radius:.125rem;box-sizing:border-box;height:6rem;object-fit:cover;padding:.5rem;width:6rem}", wr = /* @__PURE__ */ p("<span>uploading files..."), $r = /* @__PURE__ */ p('<div class=ink-drop-zone><style></style><div class=ink-drop-zone-modal><div class=ink-drop-zone-droppable-area><div class=ink-drop-zone-file-preview></div><!$><!/></div><div class=ink-drop-zone-hide><svg xmlns=http://www.w3.org/2000/svg fill=none viewBox="0 0 24 24"stroke=currentColor><path stroke-linecap=round stroke-linejoin=round stroke-width=2 d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z">'), _r = /* @__PURE__ */ p("<img class=ink-drop-zone-file-preview-image>"), Mr = /* @__PURE__ */ p("<span>drop files here"), Sr = () => {
  const [e, n] = R(0), [t, r] = R([]), [o, i] = R(!1), [s, a] = R(!1), [l, c] = Y(), f = () => {
    ...
    if (l().options.files.clipboard) {
      ...
      $?.files && $.files.length > 0 && T($.files);
    }
  }, T = (b) => {
    Array.from(b).forEach(($) => {
      r([...t(), $]);
    }), i(!0), a(!0), Promise.resolve(l().options.files.handler(b)).then(($) => {
      if (l().options.files.injectMarkup && $) {
        const Z = `![](${$})`;
        de([l, c], Z);
      }
    }).finally(() => {
  ...
  return We(() => {
    document.addEventListener("dragenter", y), document.addEventListener("dragleave", S), document.addEventListener("dragover", w), document.addEventListener("drop", q), l().root.addEventListener("paste", I);
  }), Ln(() => {
    document.removeEventListener("dragenter", y), document.removeEventListener("dragleave", S), document.removeEventListener("dragover", w), document.removeEventListener("drop", q), l().root.removeEventListener("paste", I);
  }), (() => {
    const b = m($r), $ = b.firstChild, Z = $.nextSibling, F = Z.firstChild, k = F.firstChild, D = k.nextSibling, [C, P] = h(D.nextSibling), O = F.nextSibling;
    return ve($, "textContent", yr), F.addEventListener("drop", _), g(k, d(En, {
      get each() {
        return t().slice(0, 8);
      },
      children: (M) => (() => {
...
}, Er = /* @__PURE__ */ p("<button class=ink-button type=button>"), E = (e) => (() => {
  const n = m(Er);
  return n.$$click = (t) => e.onclick(t), g(n, () => e.children), ye(), n;
})();
Te(["click"]);
const jr = ".ink-mde .ink-mde-toolbar{background-color:var(--ink-internal-block-background-color);color:inherit;display:flex;flex-shrink:0;overflow-x:auto;padding:.25rem}.ink-mde .ink-mde-toolbar .ink-mde-container{display:flex;gap:var(--ink-internal-toolbar-group-spacing)}.ink-mde .ink-mde-toolbar-group{display:flex;gap:var(--ink-internal-toolbar-item-spacing)}.ink-mde .ink-mde-toolbar .ink-button{align-items:center;background:none;border:none;border-radius:var(--ink-internal-border-radius);color:inherit;cursor:pointer;display:flex;height:2.25rem;justify-content:center;padding:.4rem;width:2.25rem}.ink-mde .ink-mde-toolbar .ink-button:hover{background-color:var(--ink-internal-block-background-color-on-hover)}.ink-mde .ink-mde-toolbar .ink-button>*{align-items:center;display:flex;height:100%}", Br = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M6 4V10M6 16V10M6 10H14M14 10V4M14 10V16">'), Ar = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-width=1.5 stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M6.5 10H10.5C12.1569 10 13.5 11.3431 13.5 13C13.5 14.6569 12.1569 16 10.5 16H6.5V4H9.5C11.1569 4 12.5 5.34315 12.5 7C12.5 8.65686 11.1569 10 9.5 10">'), zr = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M11 4L9 16M13 4H9M7 16H11">'), oe = /* @__PURE__ */ p("<div class=ink-mde-toolbar-group><!$><!/><!$><!/><!$><!/>"), Hr = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M2.00257 16H17.9955M2.00055 4H18M7 10H18.0659M2 8.5V11.4999C2.4 11.5 2.5 11.5 2.5 11.5V11V10.5M4 8.5V11.4999H4.5V11V10.5">'), Tr = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M13 4L7 16"></path><path d="M5 7L2 10L5 13"></path><path d="M15 7L18 10L15 13">'), Dr = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M7 4L8 6">'), Pr = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M7 16H17.8294"></path><path d="M2 16H4"></path><path d="M7 10H17.8294"></path><path d="M2 10H4"></path><path d="M7 4H17.8294"></path><path d="M2 4H4">'), Or = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M7 16H18"></path><path d="M2 17.0242C2.48314 17.7569 3.94052 17.6154 3.99486 16.7919C4.05315 15.9169 3.1975 16.0044 2.99496 16.0044M2.0023 14.9758C2.48544 14.2431 3.94282 14.3846 3.99716 15.2081C4.05545 16.0831 3.1998 16.0002 2.99726 16.0002"></path><path d="M7 10H18"></path><path d="M2.00501 11.5H4M2.00193 8.97562C2.48449 8.24319 3.9401 8.38467 3.99437 9.20777C4.05259 10.0825 2.04342 10.5788 2 11.4996"></path><path d="M7 4H18"></path><path d="M2 5.5H4M2.99713 5.49952V2.5L2.215 2.93501">'), qr = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M7 16H17.8294"></path><path d="M5 15L3 17L2 16"></path><path d="M7 10H17.8294"></path><path d="M5 9L3 11L2 10"></path><path d="M7 4H17.8294"></path><path d="M5 3L3 5L2 4">'), Ir = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M9.12127 10.881C10.02 11.78 11.5237 11.7349 12.4771 10.7813L15.2546 8.00302C16.2079 7.04937 16.253 5.54521 15.3542 4.6462C14.4555 3.74719 12.9512 3.79174 11.9979 4.74539L10.3437 6.40007M10.8787 9.11903C9.97997 8.22002 8.47626 8.26509 7.52288 9.21874L4.74545 11.997C3.79208 12.9506 3.74701 14.4548 4.64577 15.3538C5.54452 16.2528 7.04876 16.2083 8.00213 15.2546L9.65633 13.5999">'), Nr = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><rect x=2 y=4 width=16 height=12 rx=1></rect><path d="M7.42659 7.67597L13.7751 13.8831M2.00208 12.9778L7.42844 7.67175"></path><path d="M11.9119 12.0599L14.484 9.54443L17.9973 12.9785"></path><path d="M10.9989 7.95832C11.551 7.95832 11.9986 7.52072 11.9986 6.98092C11.9986 6.44113 11.551 6.00354 10.9989 6.00354C10.4468 6.00354 9.99921 6.44113 9.99921 6.98092C9.99921 7.52072 10.4468 7.95832 10.9989 7.95832Z">'), Rr = /* @__PURE__ */ p('<svg viewBox="0 0 20 20"fill=none stroke=currentColor stroke-miterlimit=5 stroke-linecap=round stroke-linejoin=round><path d="M10 13V4M10 4L13 7M10 4L7 7"></path><path d="M2 13V15C2 15.5523 2.44772 16 3 16H17C17.5523 16 18 15.5523 18 15V13">'), Vr = /* @__PURE__ */ p("<input type=file>"), Wr = /* @__PURE__ */ p("<div class=ink-mde-toolbar><style></style><div class=ink-mde-container><!$><!/><!$><!/><!$><!/><!$><!/>"), Fr = () => {
  ...
  return (() => {
    const a = m(Wr), l = a.firstChild, c = l.nextSibling, f = c.firstChild, [_, y] = h(f.nextSibling), S = _.nextSibling, [w, q] = h(S.nextSibling), I = w.nextSibling, [T, b] = h(I.nextSibling), $ = T.nextSibling, [Z, F] = h($.nextSibling);
    return ve(l, "textContent", jr), g(c, d(x, {
      get when() {
...
${Ur}`)), o;
...
}, Xr = /* @__PURE__ */ p('<div class="ink ink-mde"><!$><!/><!$><!/><!$><!/><div class=ink-mde-editor></div><!$><!/>'), Yr = (e) => {
  const [n, t] = Y(), r = (o) => {
    t(ee(n(), {
      root: o
    }));
  ...
  return (() => {
    const o = m(Xr), i = o.firstChild, [s, a] = h(i.nextSibling), l = s.nextSibling, [c, f] = h(l.nextSibling), _ = c.nextSibling, [y, S] = h(_.nextSibling), w = y.nextSibling, q = w.nextSibling, [I, T] = h(q.nextSibling);
...
}, un = Bn([() => xe(), (e) => typeof e == "function" ? e(xe()) : e]), Zr = (e) => (
...
}), Jr = /* @__PURE__ */ p("<div class=ink-mde-textarea>"), fo = (e) => e, mo = (e) => e, go = (e) => e, Gr = (e, n = {}) => {
  const t = Le(n);
  return no(), hn(() => d(fn, {
    store: t,
    target: e
  }), e), tn(t);
}, po = (e, n = {}) => e.querySelector(Hn) ? Gr(e, n) : mn(e, n), eo = ({
  key: e = "",
  type: n,
  value: t
}) => new Proxy({
...
//# sourceMappingURL=index-J7cEK7bf.js.map
